...
2. Create a project
3. Register that project
4. Copy the install npm link and install firebase
5. Copy the firebase config.js code and paste it with create a new file in your vs code 
